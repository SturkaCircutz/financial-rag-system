...
class OpenApiContractTest {
    ...
    void openApiContractDocumentsReportEndpointsAndErrors() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$['paths']['/api/v1/reports/{reportId}/citations']['get']").exists())
                .andExpect(jsonPath("$['paths']['/api/v1/reports/{reportId}/export']['get']").exists())
                ...
                .andExpect(jsonPath("$['components']['schemas']['CitationDetail']", notNullValue()))
                .andExpect(jsonPath("$['components']['schemas']['ReportHistoryResponse']", notNullValue()))
